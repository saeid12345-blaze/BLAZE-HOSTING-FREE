...
@app.route('/')
def home():
    return f"<h1>BLAZE Hosting Test Server</h1><p>Running at {time.ctime()}</p>"
...
def login():
    ...
    <head>
        ...
        <title>BLAZE Hosting | Login</title>
        <style>
    ...
    <body>
        ...
        <div class="login-container">
            <div class="logo">BLQZE Hosting</div>
...
if __name__ == "__main__":
    ...
    print(f"""
    ╔══════════════════════════════════════════╗
    ║      BLAZE Hosting - Unlimited Servers    ║
